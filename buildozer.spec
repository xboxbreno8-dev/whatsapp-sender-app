...
title = WhatsApp Sender Brenoxxx

# (str) Package name
package.name = whatsappsender

# (str) Package domain (needed for android/ios packaging)
package.domain = br.brenoxxx.whatsappsender

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,txt,xlsx,xls
...
requirements = python3,kivy==2.1.0,pandas,openpyxl,xlrd
